...
export function MenuScreen({ chapter, chapterSubtitle, onStart }: MenuProps) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-h-full overflow-y-auto py-8 scrollbar-hidden">
        {/* Archmage sigil — the game icon rendered on the landing page */}
        <div className="anim-fade-up">
          <img
            src={`${ASSET_BASE}/icon-512.png`}
            alt="Archmage sigil"
            draggable={false}
            className="archmage-sigil"
          />
        </div>

        <div className="anim-fade-up flex items-center gap-3 text-[#9a7bff] -mt-2">
        ...
        <h1 className="anim-fade-up-1 font-display title-glow text-[#f5e3b3] font-black leading-none mt-2 text-[clamp(52px,9vw,110px)] tracking-[0.08em]">
          ARCHMAGE
        </h1>
        ...
        <div className="anim-fade-up-3 mt-4 grid grid-cols-1 sm:grid-cols-[auto_auto] gap-x-14 gap-y-1 rune-panel px-7 py-3 text-left">
          ...
          <div className="sm:border-l sm:border-[rgba(154,123,255,0.32)] sm:pl-10">
            ...
            <p className="text-[12px] text-[#8f7bff] italic max-w-65">
                      ...
                      <div className="p-3.5">
                        ...
                        {seen ? (
                          <>
                            ...
                            <div className="mt-2.5 pt-2 border-t border-[#2a1d4d] grid grid-cols-4 gap-1 text-center text-[10.5px] font-bold uppercase tracking-widest text-[#6a5a99]">
